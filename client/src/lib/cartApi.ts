...
function isCartLine(value: unknown): value is CartLine {
  ...
  return (
    ...
    // Optional on the wire-guard (fixtures predate it); the server always
    // sends the enum key, and an unknown key simply renders unit-less.
    (value.dosageForm === undefined || typeof value.dosageForm === 'string') &&
